    ...
    <div class='form-kategorie'> 
        ...
        <div class='dropdown'>
            ...
            <ul class='dropdown-list'>
                <li class='dropdown-list__item' data-value='Food'>Food</li>
                <li class='dropdown-list__item' data-value='Shopping'>Shopping</li>
                <li class='dropdown-list__item' data-value='Fuel'>Fuel</li>
                <li class='dropdown-list__item' data-value='Transport'>Transport</li>
